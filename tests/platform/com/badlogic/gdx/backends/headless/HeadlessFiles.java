 ...
 * @author Nathan Sweet
 */
public final class HeadlessFiles extends AndroidFiles {

	public HeadlessFiles(AssetManager assets) {
		super(assets);
	}

	public HeadlessFiles(AssetManager assets, String localpath) {
